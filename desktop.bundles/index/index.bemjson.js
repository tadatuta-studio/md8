                                            ...
                                            content: [
                                                buildCarousel(58, 16),
                                                {
                                                    ...
                                                    content: [
                                                        ...
                                                        'Понимание взаимосвязи размеров и объема. ',
                                                        'Приобретет основы научных знаний. Усвоит определения тех, или иных явлений, предметов и понятий. ',
                                                        'Запоминать до 4-9 предметов и их порядок ',
                                                        'Видит связь предметов не только про внешним свойствам (цвета, размер), но и по назначению (посуда, инструменты, рыболовные снасти)',
                                                        'Сравнение множества предметов и выстраивание их по порядку, по весу, по размеру, и т. д.',
