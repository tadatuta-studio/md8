...
module.exports = {
    ...
    head: [
        ...
        { elem: 'css', url: isProd ? 'content/styles.min.css' : 'index.min.css' },
        [
            {
                property: 'og:title',
    ...
    scripts: [{ elem: 'js', url: isProd ? 'scripts/scripts.min.js' : 'index.min.js' }],
    content: [
        {
            block: 'section',
            mix: { block: 'header' },
            ...
            content: [
                {
                    ...
                    content: [
                        ...
                        },
                        {
                            ...
                            url: 'http://www.magicdesktop.com/get@(Functions.GetQueryStringParams())',
